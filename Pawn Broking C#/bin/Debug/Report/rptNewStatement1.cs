...
namespace Pawn_Broking.Report {
    ...
    public class rptNewStatement1 : ReportClass {
        
        public rptNewStatement1() {
        }
        
        public override string ResourceName {
            get {
                return "rptNewStatement1.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "Pawn_Broking.Report.rptNewStatement1.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedrptNewStatement1 : Component, ICachedReport {
        
        public CachedrptNewStatement1() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            rptNewStatement1 rpt = new rptNewStatement1();
            rpt.Site = this.Site;
            return rpt;
        }
