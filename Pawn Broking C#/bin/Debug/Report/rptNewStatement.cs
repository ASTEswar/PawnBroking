...
namespace Pawn_Broking.Report {
    ...
    public class rptNewStatement : ReportClass {
        
        public rptNewStatement() {
        }
        
        public override string ResourceName {
            get {
                return "rptNewStatement.rpt";
            }
            set {
                // Do nothing
            }
        ...
        public override string FullResourceName {
            get {
                return "Pawn_Broking.Report.rptNewStatement.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedrptNewStatement : Component, ICachedReport {
        
        public CachedrptNewStatement() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            rptNewStatement rpt = new rptNewStatement();
            rpt.Site = this.Site;
            return rpt;
        }
