...
namespace Pawn_Broking.Report {
    ...
    public class rptLoanBill : ReportClass {
        ...
        public override string FullResourceName {
            get {
                return "Pawn_Broking.Report.rptLoanBill.rpt";
            }
            set {
                // Do nothing
            }
    ...
    public class CachedrptLoanBill : Component, ICachedReport {
        
        public CachedrptLoanBill() {
        }
        ...
        public virtual CrystalDecisions.CrystalReports.Engine.ReportDocument CreateReport() {
            rptLoanBill rpt = new rptLoanBill();
            rpt.Site = this.Site;
            return rpt;
        }
